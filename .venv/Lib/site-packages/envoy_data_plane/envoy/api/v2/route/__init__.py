...
class VirtualHost(betterproto.Message):
    ...
    request_headers_to_add: List["_core__.HeaderValueOption"] = (
    ...
    response_headers_to_add: List["_core__.HeaderValueOption"] = (
    ...
    per_filter_config: Dict[str, "betterproto_lib_google_protobuf.Struct"] = (
...
class WeightedClusterClusterWeight(betterproto.Message):
    ...
    add up to the total_weight, if total_weight is greater than 0.
    """
...
class CorsPolicy(betterproto.Message):
    ...
    allow_origin_string_match: List["___type_matcher__.StringMatcher"] = (
...
class RouteAction(betterproto.Message):
    ...
    *regex_rewrite* may be specified. Examples using Google's `RE2
    ...
    ``STRICT_DNS``,  ``LOGICAL_DNS`` or ``STATIC``. For ``STATIC`` clusters,
    the hostname attribute of the endpoint must be configured. Setting this to
    true with other cluster types has no effect.
    """
