...
class CertificateValidationContextTrustChainVerification(betterproto.Enum):
    ...
    route matching. ( see :ref:`validated
    <envoy_api_field_route.RouteMatch.TlsContextMatchOptions.validated>` ).
    """
...
class TlsCertificate(betterproto.Message):
    ...
    signed_certificate_timestamp: List["_core__.DataSource"] = (
...
class CertificateValidationContext(betterproto.Message):
    ...
    match_subject_alt_names: List["___type_matcher__.StringMatcher"] = (
