...
class StatsSink(betterproto.Message):
    ...
    <envoy_api_msg_config.metrics.v2.StatsdSink>` *
    :ref:`envoy.stat_sinks.dog_statsd
    <envoy_api_msg_config.metrics.v2.DogStatsdSink>` *
    :ref:`envoy.stat_sinks.metrics_service
    <envoy_api_msg_config.metrics.v2.MetricsServiceConfig>` *
    :ref:`envoy.stat_sinks.hystrix
    <envoy_api_msg_config.metrics.v2.HystrixSink>` Sinks optionally support
    tagged/multiple dimensional metrics.
    """
...
class StatsConfig(betterproto.Message):
    ...
    :ref:`TagSpecifiers <envoy_api_msg_config.metrics.v2.TagSpecifier>` cannot
    ...
    <envoy_api_field_config.metrics.v2.StatsConfig.stats_tags>`. They will be
...
class StatsMatcher(betterproto.Message):
    ...
    exclusion_list: "___type_matcher__.ListStringMatcher" = betterproto.message_field(
        2, group="stats_matcher"
    )
    """
    ...
    inclusion_list: "___type_matcher__.ListStringMatcher" = betterproto.message_field(
        3, group="stats_matcher"
    )
    """
...
class TagSpecifier(betterproto.Message):
    ...
    :ref:`tag_name <envoy_api_field_config.metrics.v2.TagSpecifier.tag_name>`
    is provided in the config and neither :ref:`regex
    <envoy_api_field_config.metrics.v2.TagSpecifier.regex>` or
    :ref:`fixed_value
    <envoy_api_field_config.metrics.v2.TagSpecifier.fixed_value>` were
...
class StatsdSink(betterproto.Message):
    ...
    address: "___api_v2_core__.Address" = betterproto.message_field(
...
class DogStatsdSink(betterproto.Message):
    ...
    <envoy_api_msg_config.metrics.v2.StatsConfig>`. [#extension:
...
class MetricsServiceConfig(betterproto.Message):
    ...
    *envoy.stat_sinks.metrics_service* :ref:`StatsSink
    <envoy_api_msg_config.metrics.v2.StatsSink>`. This opaque configuration
